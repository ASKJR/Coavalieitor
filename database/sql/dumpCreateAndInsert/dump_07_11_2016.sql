...
-- Copiando dados para a tabela coavalieitor_db.aluno: ~101 rows (aproximadamente)
...
INSERT INTO `avaliacao` (`id`, `nome`, `descricao`, `requisito_adicional`, `submissao_inicial`, `submissao_final`, `correcao_inicial`, `correcao_final`, `num_correcao_estudante`, `nota_maxima`, `criterio_correcao`, `turma_id`) VALUES
	...
	(7, 'Testa ALFA', 'jhdasdajdjadja', 'asdajdjkasdjkadsjk', '2016-11-02 00:00:00', '2016-11-05 23:59:00', '2016-11-06 00:00:00', '2016-11-09 23:59:00', 2, 100, 'Faça seu melhor.', 2);
...
-- Copiando dados para a tabela coavalieitor_db.correcao: ~21 rows (aproximadamente)
...
-- Copiando dados para a tabela coavalieitor_db.correcao_final: ~12 rows (aproximadamente)
...
INSERT INTO `correcao_final` (`id`, `feedback`, `nota_final`, `avaliacao_id`, `aluno_usuario_id`, `correcao_visivel`, `correcao_final_data`) VALUES
	(1, 'Lega', 100, 1, 31, 1, '2016-11-05 16:36:18'),
	...
	(6, 'xxxxxxx', 60, 2, 31, 1, '2016-11-05 21:12:13'),
	(7, 'olá. katoooooo', 50, 1, 30, 1, '2016-11-03 22:09:03'),
	(8, 'vvvvv', 7000, 7, 50, 1, '2016-11-03 22:10:27'),
...
-- Copiando dados para a tabela coavalieitor_db.matricula: ~13 rows (aproximadamente)
...
-- Copiando dados para a tabela coavalieitor_db.professor: ~7 rows (aproximadamente)
...
-- Copiando dados para a tabela coavalieitor_db.solucao: ~9 rows (aproximadamente)
...
-- Copiando dados para a tabela coavalieitor_db.turma: ~9 rows (aproximadamente)
...
-- Copiando dados para a tabela coavalieitor_db.usuario: ~108 rows (aproximadamente)
