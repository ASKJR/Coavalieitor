...
<%@include file="include/header.jsp" %>
    <div class="wrapper">
        <form class="form-signin" action="RecuperarSenhaController" method="POST">       
            ...
            <input class="form-control" name="email" type="email" placeholder="Email" required autofocus="" /><br>
